...
Hey! Welcome to the {{.company_name}} team, we’re so excited to have you with us. We’re hoping you’re going to learn a lot working here and that we’ll learn a lot from you. But first, this document will help you start figuring out how {{.company_name}} works and how we work together.

At {{.company_name}}, we’re trying to build an inclusive and value-driven organization, so you’ll find that a lot of our policies differ from the norm at other companies. If you have any questions about why we do things a certain way, or have a suggestion about how we can do anything better, please let us know (or just write comments in the documents -- you should already have comment access to everything in the {{.company_name}} handbook!).  

## Your First Day

Hopefully by the time you’re actually starting at {{.company_name}}, you’ve already finished filling out the paperwork and you’ve showed up to a desk with a new computer and the accessories that fit your work-style. Today is all about getting you set up and making sure you’re ready to go.

**The goal for today is for you to publish _something_ live.** If you’re a designer, that could be a color change for a button. If you’re a developer, it might be fixing a missing semicolon. It could be a tweet from the {{.company_name}} account or a blog post, a support response or an infographic. Whatever you’ll be doing at {{.company_name}}, we want you to ship something small today.
...
## The Basics about {{.company_name}}

**{{.company_name}} is a values-driven company.** Hopefully you heard about this a lot during your interview process, but we take our values really seriously at {{.company_name}} and they guide the decisions we make here. You can read more about the [{{.company_name}} Values]({{.handbook_github_repo}}/blob/master/Values.md), but the short versions are:
...
**{{.company_name}} isn’t a normal security company.** Security is traditionally a very technical and inaccessible field. At {{.company_name}}, we’re working to make security easy and approachable to everyone, and that radiates through everything we do. Our product is meant to be friendly and fun, and our attitude should never feel superior or smug. {{.company_name}} isn’t about protecting people, it’s about empowering them.
...
## The {{.company_name}} Team, Hours, and Office

For now, {{.company_name}} operates as a single team where everyone is working towards company-level goals. Since we’re still small, there’s not too much overhead in keeping up with everyone. There are still engineering-specific meetings, and marketing conversations that happen separately. But when we set our goals, we all think directly about how we contribute to the company goals. You’ll get to work with everyone at {{.company_name}} in some capacity, and dip your fingers into all different kinds of thinking.
...
You should expect a typical workweek at {{.company_name}} to be 45-50 hours. Most people show up between 9 and 10 and leave between 6 and 7. We don’t work weekends, but a lot of us host or go to events at night. This is to give you a sense of what’s normal here, but you should work the hours that are healthy and sustainable for you.

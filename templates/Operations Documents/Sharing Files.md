# Sharing Files at {{.company_name}}

## Base Directories

At the base of every member of the {{.company_name}} team’s directory, there should be 6 directories:

1. **[{{.company_name}} Handbook]({{.handbook_docs_url}})** -- a collection of documents about how we do things at {{.company_name}}, which anyone can comment on

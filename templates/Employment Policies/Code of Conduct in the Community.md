...
This code of conduct applies to community members and {{.company_name}} team members in all {{.company_name}} communities online (including but not limited to IRC, support chat, the {{.company_name}} Community Slack group, Twitter, and Facebook), in the {{.company_name}} office, and at all events hosted by {{.company_name}}.
...
Participants asked to stop any harassing behavior are expected to comply immediately. Community members violating these rules may be sanctioned or removed from community spaces. If you are being harassed, notice that someone else is being harassed, or have any other concerns, please contact {{.ceo_name}} ({{.ceo_email}}) or one of the other founders immediately.

...
Every employee is an important contributor to the decisions we make and the work we do as a team, so we expect full-time employees to be at the {{.company_name}} office between 45 and 50 hours a week, and to be punctual for team meetings. If employees have a consideration which requires them to be out of the office, they should get approval from the {{.reporting_structure}} as far in advance as possible, and at least a full day before the absence.

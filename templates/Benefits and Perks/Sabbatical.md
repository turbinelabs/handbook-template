...
After every 5 years of working at {{.company_name}}, employees are encouraged to take a one-quarter (12 contiguous weeks) paid sabbatical.
...
There is an expectation that employees return to work at {{.company_name}} after their sabbatical, and not use it as a soft exit from the company. We may set some policy to enforce this later.

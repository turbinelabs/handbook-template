...
Taking time off and recharging is critical to doing your best work at {{.company_name}}, so in addition to the recognized [Holiday List]({{.handbook_github_repo}}/blob/master/Benefits%20and%20Perks/Holiday%20List.md), {{.company_name}} offers 3 weeks (15 days) of paid vacation every year that accrues 1.25 of a day per month of work. Employees should schedule their vacations, let the rest of the team know, and add it to their shared work calendar at least a week in advance.
